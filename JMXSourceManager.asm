; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\workspaces\newagent2\runtime.tools\src\ibmras\monitoring\plugins\jmx\JMXSourceManager.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG95853 DB	'Registering pull sources', 00H
	ORG $+3
$SG95861 DB	'Starting', 00H
	ORG $+3
$SG95872 DB	'Stopping', 00H
CONST	ENDS
...
_TEXT	ENDS
PUBLIC	??0JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAE@XZ ; ibmras::monitoring::plugins::jmx::JMXSourceManager::JMXSourceManager
EXTRN	?vm@jmx@plugins@monitoring@ibmras@@3PAUJavaVM_@@A:DWORD ; ibmras::monitoring::plugins::jmx::vm
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAE@XZ PROC ; ibmras::monitoring::plugins::jmx::JMXSourceManager::JMXSourceManager
; _this$ = ecx
; File c:\workspaces\newagent2\runtime.tools\src\ibmras\monitoring\plugins\jmx\jmxsourcemanager.cpp
; Line 24
	push	ebp
...
; Line 28
	mov	DWORD PTR ?vm@jmx@plugins@monitoring@ibmras@@3PAUJavaVM_@@A, 0 ; ibmras::monitoring::plugins::jmx::vm
; Line 29
	mov	eax, DWORD PTR _this$[ebp]
	mov	esp, ebp
	pop	ebp
	ret	0
??0JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAE@XZ ENDP ; ibmras::monitoring::plugins::jmx::JMXSourceManager::JMXSourceManager
_TEXT	ENDS
PUBLIC	?registerPullSource@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEPAUpullsource@@I@Z ; ibmras::monitoring::plugins::jmx::JMXSourceManager::registerPullSource
EXTRN	?getOSPullSource@os@jmx@plugins@monitoring@ibmras@@YAPAVJMXPullSource@2345@I@Z:PROC ; ibmras::monitoring::plugins::jmx::os::getOSPullSource
...
_src$ = -4						; size = 4
_provID$ = 8						; size = 4
?registerPullSource@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEPAUpullsource@@I@Z PROC ; ibmras::monitoring::plugins::jmx::JMXSourceManager::registerPullSource
; _this$ = ecx
; Line 31
	push	ebp
	mov	ebp, esp
...
; Line 34
	...
	add	esp, 4
	mov	DWORD PTR $T102159[ebp], eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR $T102159[ebp]
	mov	DWORD PTR [ecx+8], edx
; Line 35
	mov	eax, DWORD PTR _provID$[ebp]
	push	eax
	call	?getOSPullSource@os@jmx@plugins@monitoring@ibmras@@YAPAVJMXPullSource@2345@I@Z ; ibmras::monitoring::plugins::jmx::os::getOSPullSource
	add	esp, 4
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	mov	DWORD PTR [edx], eax
...
; Line 42
	...
	pop	ebp
	ret	4
?registerPullSource@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEPAUpullsource@@I@Z ENDP ; ibmras::monitoring::plugins::jmx::JMXSourceManager::registerPullSource
_TEXT	ENDS
PUBLIC	?start@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEHXZ ; ibmras::monitoring::plugins::jmx::JMXSourceManager::start
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -12						; size = 4
_p$95866 = -8						; size = 4
_i$95862 = -4						; size = 4
?start@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEHXZ PROC ; ibmras::monitoring::plugins::jmx::JMXSourceManager::start
; _this$ = ecx
; Line 44
	push	ebp
	mov	ebp, esp
...
$LN5@start:
; Line 46
	mov	DWORD PTR _i$95862[ebp], 0
	jmp	SHORT $LN4@start
$LN3@start:
	mov	edx, DWORD PTR _i$95862[ebp]
	add	edx, 1
	mov	DWORD PTR _i$95862[ebp], edx
$LN4@start:
	cmp	DWORD PTR _i$95862[ebp], 1
	jae	SHORT $LN2@start
; Line 47
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	...
	mov	DWORD PTR _p$95866[ebp], eax
; Line 48
	cmp	DWORD PTR _p$95866[ebp], 0
	je	SHORT $LN1@start
; Line 49
	mov	ecx, DWORD PTR _p$95866[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _p$95866[ebp]
...
; Line 53
	...
	pop	ebp
	ret	0
?start@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEHXZ ENDP ; ibmras::monitoring::plugins::jmx::JMXSourceManager::start
_TEXT	ENDS
PUBLIC	?stop@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEHXZ ; ibmras::monitoring::plugins::jmx::JMXSourceManager::stop
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv80 = -24						; size = 4
_this$ = -20						; size = 4
...
_p$95877 = -8						; size = 4
_i$95873 = -4						; size = 4
?stop@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEHXZ PROC ; ibmras::monitoring::plugins::jmx::JMXSourceManager::stop
; _this$ = ecx
; Line 55
	push	ebp
	mov	ebp, esp
...
$LN4@stop:
; Line 57
	mov	DWORD PTR _i$95873[ebp], 0
	jmp	SHORT $LN3@stop
$LN2@stop:
	mov	edx, DWORD PTR _i$95873[ebp]
	add	edx, 1
	mov	DWORD PTR _i$95873[ebp], edx
$LN3@stop:
	cmp	DWORD PTR _i$95873[ebp], 1
	jae	SHORT $LN1@stop
; Line 58
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	mov	edx, DWORD PTR _i$95873[ebp]
	mov	eax, DWORD PTR [ecx+edx*4]
	mov	DWORD PTR _p$95877[ebp], eax
; Line 59
	mov	ecx, DWORD PTR _p$95877[ebp]
	mov	DWORD PTR $T102163[ebp], ecx
	mov	edx, DWORD PTR $T102163[ebp]
	mov	DWORD PTR $T102162[ebp], edx
	cmp	DWORD PTR $T102162[ebp], 0
	je	SHORT $LN7@stop
	push	1
	mov	eax, DWORD PTR $T102162[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T102162[ebp]
...
; Line 62
	...
	pop	ebp
	ret	0
?stop@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEHXZ ENDP ; ibmras::monitoring::plugins::jmx::JMXSourceManager::stop
_TEXT	ENDS
PUBLIC	?getProvID@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEIXZ ; ibmras::monitoring::plugins::jmx::JMXSourceManager::getProvID
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getProvID@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEIXZ PROC ; ibmras::monitoring::plugins::jmx::JMXSourceManager::getProvID
; _this$ = ecx
; Line 64
	push	ebp
	mov	ebp, esp
...
; Line 66
	...
	pop	ebp
	ret	0
?getProvID@JMXSourceManager@jmx@plugins@monitoring@ibmras@@QAEIXZ ENDP ; ibmras::monitoring::plugins::jmx::JMXSourceManager::getProvID
_TEXT	ENDS
...
_TEXT	SEGMENT
_this$ = -12						; size = 4
__Ptr$97634 = -8					; size = 4
__Ptr$97624 = -4					; size = 4
__Right$ = 8						; size = 4
...
; Line 719
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$97624[ebp], eax
; Line 720
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	eax, DWORD PTR __Ptr$97624[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 725
	...
	mov	DWORD PTR __Ptr$97634[ebp], edx
; Line 726
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	push	ecx
	mov	edx, DWORD PTR __Ptr$97634[ebp]
	push	edx
	mov	eax, DWORD PTR __Right$[ebp]
	mov	ecx, DWORD PTR [eax]
	push	ecx
...
; Line 727
	...
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	eax, DWORD PTR __Ptr$97634[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 1992
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR __Ptr$97825[ebp], eax
; Line 1993
...
; Line 1994
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$97825[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	push	eax
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
...
; Line 1995
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$97825[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 1218
	...
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T102244[ebp], ecx
	lea	edx, DWORD PTR $T102247[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	...
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR $T102246[ebp], eax
	mov	ecx, DWORD PTR $T102244[ebp]
	push	ecx
	mov	edx, DWORD PTR $T102246[ebp]
	push	edx
	lea	eax, DWORD PTR $T102248[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 1117
	...
	mov	DWORD PTR __Newsize$98856[ebp], eax
; Line 1118
	mov	ecx, DWORD PTR __Newsize$98856[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; Line 1952
	...
	mov	DWORD PTR _this$[ebp], ecx
; Line 1953
	mov	BYTE PTR $T102269[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+16], ecx
	lea	edx, DWORD PTR $T102269[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; Line 1207
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$99271[ebp], eax
; Line 1210
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	eax, DWORD PTR __Ptr$99271[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Destroy@?$vector@PAVLogger@common@ibmras@@V?$allocator@PAVLogger@common@ibmras@@@std@@@std@@IAEXPAPAVLogger@common@ibmras@@0@Z ; std::vector<ibmras::common::Logger *,std::allocator<ibmras::common::Logger *> >::_Destroy
; Line 1211
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$99271[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN1@erase@2:
; Line 1213
	mov	eax, DWORD PTR __First$[ebp]
	mov	DWORD PTR $T102292[ebp], eax
	mov	ecx, DWORD PTR $T102292[ebp]
	push	ecx
...
; Line 2165
	...
	add	esp, 8
	mov	BYTE PTR $T102351[ebp], al
	movzx	edx, BYTE PTR $T102351[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; Line 88
	...
	call	??$_Ptr_cat@PAVLogger@common@ibmras@@PAV123@@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAVLogger@common@ibmras@@0@Z ; std::_Ptr_cat<ibmras::common::Logger *,ibmras::common::Logger *>
	add	esp, 8
	mov	BYTE PTR $T102356[ebp], al
	movzx	edx, BYTE PTR $T102356[ebp]
	push	edx
...
; Line 2535
	...
	call	??$_Ptr_cat@PAVLogger@common@ibmras@@PAV123@@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAVLogger@common@ibmras@@0@Z ; std::_Ptr_cat<ibmras::common::Logger *,ibmras::common::Logger *>
	add	esp, 8
	mov	BYTE PTR $T102359[ebp], al
	movzx	edx, BYTE PTR $T102359[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; Line 414
	...
	add	esp, 8
	mov	BYTE PTR $T102377[ebp], al
	movzx	edx, BYTE PTR $T102377[ebp]
	push	edx
	mov	eax, DWORD PTR __Al$[ebp]
	push	eax
...
; Line 414
	...
	call	??$_Ptr_cat@PAVLogger@common@ibmras@@PAV123@@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAVLogger@common@ibmras@@0@Z ; std::_Ptr_cat<ibmras::common::Logger *,ibmras::common::Logger *>
	add	esp, 8
	mov	BYTE PTR $T102384[ebp], al
	movzx	edx, BYTE PTR $T102384[ebp]
	push	edx
	mov	eax, DWORD PTR __Al$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Dest$[ebp]
...
; Line 48
	...
	add	esp, 8
	mov	DWORD PTR $T102425[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T102425[ebp], 0
	je	SHORT $LN3@Construct
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	call	??$forward@ABQAVLogger@common@ibmras@@@std@@YAABQAVLogger@common@ibmras@@ABQAV123@@Z ; std::forward<ibmras::common::Logger * const &>
	add	esp, 4
	mov	ecx, DWORD PTR $T102425[ebp]
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR $T102425[ebp]
	mov	DWORD PTR tv73[ebp], eax
