...
//if we have a remote agent we want to change the agentLibPath here
	...
	ibmras::monitoring::Plugin* environment =
			ibmras::monitoring::plugins::j9::environment::EnvironmentPlugin::getPlugin(
					&tDPP);
	ibmras::monitoring::Plugin* locking =
			ibmras::monitoring::plugins::j9::locking::LockingPlugin::getPlugin(
					&tDPP);
	ibmras::monitoring::Plugin* threads =
			ibmras::monitoring::plugins::j9::threads::ThreadsPlugin::getPlugin(
					&tDPP);
	ibmras::monitoring::Plugin* memory =
			ibmras::monitoring::plugins::j9::memory::MemoryPlugin::getPlugin(
					&tDPP);
	ibmras::monitoring::Plugin* memorycounters =
			ibmras::monitoring::plugins::j9::memorycounters::MemCountersPlugin::getPlugin(
					tDPP);
	ibmras::monitoring::Plugin* cpu =
			ibmras::monitoring::plugins::j9::cpu::CpuPlugin::getPlugin(&tDPP);
