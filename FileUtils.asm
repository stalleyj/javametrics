; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\workspaces\newagent2\runtime.tools\src\ibmras\common\util\FileUtils.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG92887 DB	'FileUtils', 00H
	ORG $+2
$SG92918 DB	'>>>HLConnector::createDirectory', 00H
$SG92923 DB	'Creating directory: %s', 00H
	ORG $+1
$SG92933 DB	'The directory was not found', 00H
$SG92935 DB	'Creating directory: %s', 00H
	ORG $+1
$SG92944 DB	'The specified directory already exists.', 00H
$SG92947 DB	'The system cannot find the path specified.', 00H
	ORG $+5
$SG92951 DB	'The filename, directory name, or volume label syntax is '
	DB	'incorrect', 00H
	ORG $+2
$SG92954 DB	'The network path was not found.', 00H
$SG92957 DB	'The directory could not be found, permissions?.', 00H
$SG92959 DB	'Creating directory: %s', 00H
	ORG $+1
$SG92968 DB	'The specified directory already exists.', 00H
$SG92971 DB	'The system cannot find the path specified.', 00H
	ORG $+1
$SG92974 DB	'<<<HLConnector::createDirectory()', 00H
CONST	ENDS
...
PUBLIC	?createDirectory@FileUtils@util@common@ibmras@@QAE_NAAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z ; ibmras::common::util::FileUtils::createDirectory
...
_pathName$ = -4						; size = 4
_path$ = 8						; size = 4
?createDirectory@FileUtils@util@common@ibmras@@QAE_NAAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z PROC ; ibmras::common::util::FileUtils::createDirectory
; _this$ = ecx
; File c:\workspaces\newagent2\runtime.tools\src\ibmras\common\util\fileutils.cpp
; Line 36
	push	ebp
	...
	mov	DWORD PTR _this$[ebp], ecx
; Line 37
	mov	eax, DWORD PTR ?logger@util@common@ibmras@@3PAVLogger@23@A ; ibmras::common::util::logger
	cmp	DWORD PTR [eax+8], 5
	jl	SHORT $LN32@createDire
	push	OFFSET $SG92918
	push	5
	mov	ecx, DWORD PTR ?logger@util@common@ibmras@@3PAVLogger@23@A ; ibmras::common::util::logger
	push	ecx
	call	?debug@Logger@common@ibmras@@QAAXW4Level@logging@23@PBDZZ ; ibmras::common::Logger::debug
	add	esp, 12					; 0000000cH
$LN32@createDire:
; Line 38
	mov	BYTE PTR _created$[ebp], 0
; Line 40
	mov	ecx, DWORD PTR _path$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR _pathName$[ebp], eax
; Line 44
	mov	edx, DWORD PTR ?logger@util@common@ibmras@@3PAVLogger@23@A ; ibmras::common::util::logger
	cmp	DWORD PTR [edx+8], 5
	jl	SHORT $LN31@createDire
...
; Line 45
	...
	mov	DWORD PTR _dirAttr$[ebp], eax
; Line 47
	cmp	DWORD PTR _dirAttr$[ebp], -1
	jne	$LN30@createDire
; Line 48
	call	DWORD PTR __imp__GetLastError@0
	mov	DWORD PTR tv81[ebp], eax
	cmp	DWORD PTR tv81[ebp], 3
	je	SHORT $LN27@createDire
	cmp	DWORD PTR tv81[ebp], 53			; 00000035H
	je	$LN14@createDire
	cmp	DWORD PTR tv81[ebp], 123		; 0000007bH
	je	$LN16@createDire
	jmp	$LN12@createDire
$LN27@createDire:
; Line 50
...
; Line 52
	...
	test	eax, eax
	jne	SHORT $LN24@createDire
; Line 53
	call	DWORD PTR __imp__GetLastError@0
	mov	DWORD PTR tv130[ebp], eax
	cmp	DWORD PTR tv130[ebp], 3
	je	SHORT $LN19@createDire
	cmp	DWORD PTR tv130[ebp], 183		; 000000b7H
	je	SHORT $LN21@createDire
	jmp	SHORT $LN22@createDire
$LN21@createDire:
; Line 56
	mov	eax, DWORD PTR ?logger@util@common@ibmras@@3PAVLogger@23@A ; ibmras::common::util::logger
	cmp	DWORD PTR [eax+8], 1
	jl	SHORT $LN20@createDire
	push	OFFSET $SG92944
	push	1
	mov	ecx, DWORD PTR ?logger@util@common@ibmras@@3PAVLogger@23@A ; ibmras::common::util::logger
	push	ecx
...
; Line 76
	...
	call	DWORD PTR __imp__CreateDirectoryA@8
	test	eax, eax
	jne	SHORT $LN9@createDire
; Line 77
	call	DWORD PTR __imp__GetLastError@0
	mov	DWORD PTR tv169[ebp], eax
	cmp	DWORD PTR tv169[ebp], 3
	je	SHORT $LN4@createDire
	cmp	DWORD PTR tv169[ebp], 183		; 000000b7H
	je	SHORT $LN6@createDire
	jmp	SHORT $LN7@createDire
$LN6@createDire:
; Line 79
	mov	edx, DWORD PTR ?logger@util@common@ibmras@@3PAVLogger@23@A ; ibmras::common::util::logger
	cmp	DWORD PTR [edx+8], 1
	jl	SHORT $LN5@createDire
	push	OFFSET $SG92968
	push	1
	mov	eax, DWORD PTR ?logger@util@common@ibmras@@3PAVLogger@23@A ; ibmras::common::util::logger
	push	eax
...
$LN1@createDire:
; Line 116
	mov	al, BYTE PTR _created$[ebp]
; Line 117
	mov	esp, ebp
	pop	ebp
	ret	4
?createDirectory@FileUtils@util@common@ibmras@@QAE_NAAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z ENDP ; ibmras::common::util::FileUtils::createDirectory
_TEXT	ENDS
...
_TEXT	SEGMENT
_this$ = -12						; size = 4
__Ptr$94726 = -8					; size = 4
__Ptr$94716 = -4					; size = 4
__Right$ = 8						; size = 4
...
; Line 719
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$94716[ebp], eax
; Line 720
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	eax, DWORD PTR __Ptr$94716[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 725
	...
	mov	DWORD PTR __Ptr$94726[ebp], edx
; Line 726
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	push	ecx
	mov	edx, DWORD PTR __Ptr$94726[ebp]
	push	edx
	mov	eax, DWORD PTR __Right$[ebp]
	mov	ecx, DWORD PTR [eax]
	push	ecx
...
; Line 727
	...
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	eax, DWORD PTR __Ptr$94726[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 1992
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR __Ptr$94917[ebp], eax
; Line 1993
...
; Line 1994
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$94917[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	push	eax
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
...
; Line 1995
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$94917[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 1218
	...
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T99329[ebp], ecx
	lea	edx, DWORD PTR $T99332[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	...
	mov	DWORD PTR $T99331[ebp], eax
	mov	ecx, DWORD PTR $T99329[ebp]
	push	ecx
	mov	edx, DWORD PTR $T99331[ebp]
	push	edx
	lea	eax, DWORD PTR $T99333[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 1117
	...
	mov	DWORD PTR __Newsize$95948[ebp], eax
; Line 1118
	mov	ecx, DWORD PTR __Newsize$95948[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; Line 1952
	...
	mov	DWORD PTR _this$[ebp], ecx
; Line 1953
	mov	BYTE PTR $T99354[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+16], ecx
	lea	edx, DWORD PTR $T99354[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; Line 1207
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$96363[ebp], eax
; Line 1210
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	eax, DWORD PTR __Ptr$96363[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Destroy@?$vector@PAVLogger@common@ibmras@@V?$allocator@PAVLogger@common@ibmras@@@std@@@std@@IAEXPAPAVLogger@common@ibmras@@0@Z ; std::vector<ibmras::common::Logger *,std::allocator<ibmras::common::Logger *> >::_Destroy
; Line 1211
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$96363[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN1@erase@2:
; Line 1213
	mov	eax, DWORD PTR __First$[ebp]
	mov	DWORD PTR $T99377[ebp], eax
	mov	ecx, DWORD PTR $T99377[ebp]
	push	ecx
...
; Line 2165
	...
	add	esp, 8
	mov	BYTE PTR $T99436[ebp], al
	movzx	edx, BYTE PTR $T99436[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; Line 88
	...
	call	??$_Ptr_cat@PAVLogger@common@ibmras@@PAV123@@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAVLogger@common@ibmras@@0@Z ; std::_Ptr_cat<ibmras::common::Logger *,ibmras::common::Logger *>
	add	esp, 8
	mov	BYTE PTR $T99441[ebp], al
	movzx	edx, BYTE PTR $T99441[ebp]
	push	edx
...
; Line 2535
	...
	call	??$_Ptr_cat@PAVLogger@common@ibmras@@PAV123@@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAVLogger@common@ibmras@@0@Z ; std::_Ptr_cat<ibmras::common::Logger *,ibmras::common::Logger *>
	add	esp, 8
	mov	BYTE PTR $T99444[ebp], al
	movzx	edx, BYTE PTR $T99444[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; Line 414
	...
	add	esp, 8
	mov	BYTE PTR $T99462[ebp], al
	movzx	edx, BYTE PTR $T99462[ebp]
	push	edx
	mov	eax, DWORD PTR __Al$[ebp]
	push	eax
...
; Line 414
	...
	call	??$_Ptr_cat@PAVLogger@common@ibmras@@PAV123@@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAVLogger@common@ibmras@@0@Z ; std::_Ptr_cat<ibmras::common::Logger *,ibmras::common::Logger *>
	add	esp, 8
	mov	BYTE PTR $T99469[ebp], al
	movzx	edx, BYTE PTR $T99469[ebp]
	push	edx
	mov	eax, DWORD PTR __Al$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Dest$[ebp]
...
; Line 48
	...
	add	esp, 8
	mov	DWORD PTR $T99510[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T99510[ebp], 0
	je	SHORT $LN3@Construct
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	call	??$forward@ABQAVLogger@common@ibmras@@@std@@YAABQAVLogger@common@ibmras@@ABQAV123@@Z ; std::forward<ibmras::common::Logger * const &>
	add	esp, 4
	mov	ecx, DWORD PTR $T99510[ebp]
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR $T99510[ebp]
	mov	DWORD PTR tv73[ebp], eax
...
; Function compile flags: /Odtp
;	COMDAT ??__Elogger@util@common@ibmras@@YAXXZ
text$yc	SEGMENT
??__Elogger@util@common@ibmras@@YAXXZ PROC		; ibmras::common::util::`dynamic initializer for 'logger'', COMDAT
; File c:\workspaces\newagent2\runtime.tools\src\ibmras\common\util\fileutils.cpp
; Line 34
	push	ebp
	mov	ebp, esp
	...
	add	esp, 4
	mov	DWORD PTR ?logger@util@common@ibmras@@3PAVLogger@23@A, eax ; ibmras::common::util::logger
	pop	ebp
	ret	0
??__Elogger@util@common@ibmras@@YAXXZ ENDP		; ibmras::common::util::`dynamic initializer for 'logger''
text$yc	ENDS
PUBLIC	?logger@util@common@ibmras@@3PAVLogger@23@A	; ibmras::common::util::logger
_BSS	SEGMENT
?logger@util@common@ibmras@@3PAVLogger@23@A DD 01H DUP (?) ; ibmras::common::util::logger
_BSS	ENDS
CRT$XCU	SEGMENT
_logger$initializer$ DD FLAT:??__Elogger@util@common@ibmras@@YAXXZ
CRT$XCU	ENDS
END
